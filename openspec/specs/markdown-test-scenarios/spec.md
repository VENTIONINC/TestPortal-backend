# markdown-test-scenarios Specification

## Purpose
Define authenticated project-owned scenario CRUD, creator attribution, and predictable retrieval and deletion behavior.
...
- **THEN** the system rejects the unsupported creator field with HTTP 400
