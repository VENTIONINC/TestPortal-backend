export const getCtrfAnalysisPrompt = (testResultsLength: number) => `
  <!-- ===== ROLE & CONTEXT ===== -->
  <role>
  ...
  <!-- ===== PRIMARY OBJECTIVE ===== -->
  <goal>
    Analyze test results from the database (CTRF reports) and categorize failed tests into one of five buckets.
  </goal>
  ...
  <!-- ===== FEW-SHOT EXAMPLES ===== -->
  <examples>
    Here are two examples of how to analyze CTRF test results from the database.
